...
if (hashtag == '#overview' || hashtag == '#nri' || hashtag == '#eligibility' || hashtag == '#set' || hashtag == '#refundoffees' || hashtag == '#admissionprocess' || hashtag == '#admissionguidelines' || hashtag == '#seatdistribution' || hashtag == '#feesstructure' || hashtag == '#documentsrequired' || hashtag == '#importantinstruction' || hashtag == '#importantdates' || hashtag == '#academicbreak' || hashtag == '#scholarships' || hashtag == '#splreservation' || hashtag == '#admnsSesd')
{
